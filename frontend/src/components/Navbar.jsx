...
const Navbar = () => {
  ...
  {/* Profile + Dropdown + Cart (all in one flex row) */}
  <div className='flex items-center gap-6 relative'>
    ...
    <Link to="/cart" className='relative'>
      ...
      <p className='absolute right-[-5px] bottom-[-5px] w-4text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'> 10</p>
    </Link>
